...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'vérkép elemzés',
    'vérkép értelmezése',
    'vérkép eredmény magyarázat',
    'vérkép mit jelent',
    'vérkép normál értékek magyarázat',
    'laboreredmény elemzés',
    'laboreredmény értelmezés AI',
    'labor lelet magyarázat',
    'vérvétel eredmény értelmezés',
    'hemoglobin értékek magyarázat',
    'fehérvérsejt szám értelmezése',
    'koleszterin értékek magyarázat',
    'pajzsmirigy eredmény értelmezés',
    'CRP gyulladásos marker értelmezés',
    'máj enzimek ALT AST magyarázat',
    'eGFR veseműködés magyarázat',
    'vérkép AI elemzés online',
    'cukorbetegség labor eredmény',
    ...
    // Long-tail use case
    'felkészülés orvosi vizsgálatra',
    'ambuláns lap értelmezés',
    'MRI röntgen ultrahang elemzés AI',
    'mit jelent a leletem',
    // AI / tech
    'AI orvosi elemzés',
    'mesterséges intelligencia egészség',
    'Claude Sonnet orvosi AI',
    'AI diagnózis segítség',
    'egészségügyi AI Magyarország',
    'second opinion online',
    'azonnali orvosi második vélemény',
    // Symptoms
    'tünetek elemzése online',
    'tüneteim leírása AI',
    'orvosi AI Magyarország',
    'PDF lelet feltöltés elemzés',
    'ingyenes AI diagnózis',
    'regisztráció nélkül orvosi segítség',
  ],
